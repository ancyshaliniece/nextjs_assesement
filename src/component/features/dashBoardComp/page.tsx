...
export default function DashBoards() {
    ...
    return (
        <div className={`mainContainer w-[100%] ${darkMode=="true"?"bg-[#000]":"bg-[#f9f9f9]"}`}>
            ...
            <div className="chartEvent pb-4 flex justify-center gap-4">
                ...
                <div className="charts w-[79%]">
                    ...
                    <div className="chart">
                        ...
                        <div className="coursesAndRevenue flex justify-between items-center mt-4">
                            {!checkBox.courses && <div className={`w-[30%] h-[300px] p-5 ${style.chartContainer} ${darkMode=="true"?"bg-[#000] text-[#fff]":"bg-[#fff] text-[#000]"}`}>
                                <Courses />
                            </div>}
                            {!checkBox.revenue && <div className={`w-[68%] h-[302px] p-5 ${style.chartContainer} ${darkMode=="true"?"bg-[#000] text-[#fff]":"bg-[#fff] text-[#000]"}`}>
                                <Revenue />
                            </div>}
                        </div>
                    </div>
                ...
                <div className="events w-[21%]">
                    {!checkBox.event && <div className={`${style.chartContainer} ${darkMode=="true"?"bg-[#000] text-[#fff]":"bg-[#fff] text-[#000]"} h-[45vh] mb-4 p-4`}>
                        <Event />
                    </div>}
                    {!checkBox.recent && <div className={`${style.chartContainer} ${darkMode=="true"?"bg-[#000] text-[#fff]":"bg-[#fff] text-[#000]"} h-[46vh]`}>
                        <RecentStudent />
                    </div>}
                </div>
